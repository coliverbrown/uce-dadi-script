...
# Call particular model to run, the model chosen here is split, isolation, secondary contact with one migration param
func = Demographics2D_modSC.SC_1m

#	Model with split, complete isolation, followed by secondary contact and one migration parameter.
...
# Parameters are: (nu1, nu2, m, Ts, Tsc)
